...
public class UserController {
    ...
    @RequestMapping(value = "/users", method = RequestMethod.GET)    //aby string wyswietlil
    ...
    @RequestMapping(value = "/users-tiles", method = RequestMethod.GET)    //aby string wyswietlil
